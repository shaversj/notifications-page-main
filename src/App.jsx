    ...
    <>
        <div className={"bg-black min-h-screen flex items-center justify-center"}>
            <div className={"lg:w-full lg:max-w-screen-lg lg:min-h-[990px] lg:bg-lg-background-color lg:flex lg:items-center"}>
                <main className={"max-w-screen-sm  lg:min-h-0 lg:mx-auto lg:max-w-[732px] bg-white font-Plus-Jakarta-Sans px-4 py-[22.5px] lg:py-0 lg:pt-8 lg:pb-7 lg:px-8 lg:rounded-2xl shadow"}>
                    {/*Header*/}
                    <div className={"flex gap-x-2 items-center"}>
                        <h1 className={"text-[20px] lg:text-[24px] lg:font-bold font-extrabold text-very-dark-blue"}>Notifications</h1>
                        <div className={"rounded-md bg-primary-blue w-[32px] h-[25px] lg:ml-1 text-light-grayish-blue-1 flex items-center justify-center font-bold"}><span>{unReadCount}</span></div>
