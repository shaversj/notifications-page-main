                ...
                <button className={"flex bg-neutral-white p-4 gap-x-[13px] rounded-xl w-full text-left"} onClick={toggleUnRead}>
                    ...
                    <div className={"text-[14px] text-dark-grayish-blue leading-[1.2rem]"}>
                        <div className={"space-x-2 text-dark-grayish-blue"}>
                            <span className={"font-bold text-black"}>{notification.name}</span>
                            <span className={"text-dark-grayish-blue "}>{notification.message}</span>
                            <span className={"text-dark-grayish-blue font-semibold"}>{notification.message_location}</span>
                        </div>
