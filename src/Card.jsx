  ...
  return (
    <>
      {notification.hasBeenRead ? (
        <button className={"flex bg-neutral-white p-4 gap-x-[13px] w-full text-left lg:gap-x-[19px] lg:px-5 lg:py-4"} onClick={toggleUnRead}>
        ...
        <button className={"flex bg-unread-gray p-4 gap-x-[13px] rounded-lg w-full text-left lg:gap-x-[19px] lg:px-5 lg:py-4 shadow-sm"} onClick={toggleRead}>
          <img className={"w-[40px] h-[40px] lg:w-[45px] lg:h-[45px] "} src={notification.avatar} alt={""} />
