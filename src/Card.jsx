...
const Card = ({avatar, name, notification, message_location, timestamp}) => {
    ...
    function changeReadStatusOfCard(){
    ...
    return (
        <>
            {isReadStatus ? (
                <button className={"flex bg-neutral-white p-4 gap-x-[13px] rounded-xl w-full text-left"} onClick={changeReadStatusOfCard}>
                ...
                (
                    <button className={"flex bg-unread-gray p-4 gap-x-[13px] rounded-xl w-full text-left"} onClick={changeReadStatusOfCard}>
                        <img className={"w-[40px] h-[40px]"} src={avatar} alt={""} />
                        <div className={"text-[14px] text-dark-grayish-blue leading-[1.2rem]"}>
                            <div className={"space-x-2 text-dark-grayish-blue"}>
                                <span className={"font-bold text-black"}>{name}</span>
